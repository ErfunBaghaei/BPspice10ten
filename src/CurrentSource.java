public class CurrentSource extends Element{
    ...
    public CurrentSource(String input){
        ...
        switch (info[3].charAt(info[3].length()-1)){
            case 'p': dc*=1e-12; break;
            case 'n': dc*=1e-9; break;
            case 'u': dc*=1e-6; break;
            case 'm': dc*=1e-3; break;
            case 'k': dc*=1e3; break;
            case 'M': dc*=1e6; break;
            case 'G': dc*=1e9; break;
        }
        ...
        switch (info[4].charAt(info[4].length()-1)){
            case 'p': ac*=1e-12; break;
            case 'n': ac*=1e-9; break;
            case 'u': ac*=1e-6; break;
            case 'm': ac*=1e-3; break;
            case 'k': ac*=1e3; break;
            case 'M': ac*=1e6; break;
            case 'G': ac*=1e9; break;
        }
