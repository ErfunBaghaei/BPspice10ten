public class Capacitor extends Element {
    ...
    public Capacitor(String input){
        ...
        switch (info[3].charAt(info[3].length()-1)){
            case 'p': capacity*=1e-12; break;
            case 'n': capacity*=1e-9; break;
            case 'u': capacity*=1e-6; break;
            case 'm': capacity*=1e-3; break;
            case 'k': capacity*=1e3; break;
            case 'M': capacity*=1e6; break;
            case 'G': capacity*=1e9; break;
